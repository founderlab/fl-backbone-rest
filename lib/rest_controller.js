...
(function() {
  ...
  module.exports = RESTController = (function(superClass) {
    ...
    RESTController.prototype.clearCache = function(callback) {
      ...
      return queue.await((function(_this) {
        return function(err) {
          if (err) {
            console.log("[" + _this.model_type.name + " controller] Error clearing cache: ", err);
          }
          if (callback) {
            return callback(err);
          }
    ...
    RESTController.prototype.render = function(req, json, callback) {
      var done, models, options, template, template_name;
      done = (function(_this) {
        return function(err, rendered_json) {
          if (err) {
            return callback(err);
          }
          return callback(null, _this.clean(rendered_json));
        };
      })(this);
    ...
    RESTController.prototype.clean = function(obj) {
