...
(function() {
  ...
  JoinTableControllerSingleton = (function() {
    ...
    JoinTableControllerSingleton.prototype.generateByOptions = function(app, options) {
      var _key, err, error, i, join_table_auth, join_table_endpoint, join_table_options, join_table_parts, join_table_url, key, len, ref, ref1, ref2, ref3, relation, results, route_parts, route_root, schema;
